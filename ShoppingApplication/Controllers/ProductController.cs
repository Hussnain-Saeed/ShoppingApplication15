...
namespace ShoppingApplication.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Price,Image,SellerId,ProductStatusId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Price,Image,SellerId,ProductStatusId")] Product product)
        {
            if (ModelState.IsValid)
            {
